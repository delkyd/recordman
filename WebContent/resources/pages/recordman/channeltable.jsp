...
<body>
				...
				<div class="conf-container ">
					<div class='onepage'>
						...
						<div class="formstyle table-responsive">
							...
							<div>
								<table id='channelTb' class="table table-condensed table-hover table-striped">
									<thead>
									</thead>
									<tbody >
									</tbody>
	...
	<script src="<%=request.getContextPath()%>/resources/js/recordman/channeltable.js"></script>
</body>
</html>