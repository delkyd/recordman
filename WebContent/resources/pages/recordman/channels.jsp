				...
				<div class="channels conf-container">	
					...
					<div class="left terminal-info formstyle">
							<form class="form-horizontal" onsubmit="return false;">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_board" bundle="${bundle }"/></label>
									<div class="col-sm-9">
										<input id='terminal_board' type="text" class="form-control" disabled>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_index" bundle="${bundle }"/></label>
									<div class="col-sm-9">
										<input id='terminal_index' type="text" class="form-control" disabled>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_name" bundle="${bundle }"/></label>
									<div class="col-sm-9">
										<input id='terminal_name' type="text" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_type" bundle="${bundle }"/></label>
									<div class="col-sm-9">
								...
								<div class="form-group onlyAi">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_Rate" bundle="${bundle }"/></label>
									<div class="col-sm-9">
										<input id='terminal_rate' type="text" class="form-control">
									</div>
								</div>
								<div class="form-group onlyBi">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_debounce" bundle="${bundle }"/></label>
									<div class="col-sm-9">
										<input id='terminal_debounce' type="text" class="form-control">
									</div>
								</div>
								<div class="form-group onlyBi">
									<label class="col-sm-3 control-label"><fmt:message key="terminal_reverse" bundle="${bundle }"/></label>
									<div class="col-sm-9">
					...
					<div class="right channel-info formstyle">
						<form class="form-horizontal" onsubmit="return false;">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label"><fmt:message key="channel_id" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_id' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label"><fmt:message key="channel_name" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_name' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyAi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_unit" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_unit' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyAi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_rate1" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_rate1' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyAi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_unit1" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_unit1' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyAi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_rate2" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_rate2' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyAi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_unit2" bundle="${bundle }"/></label>
								<div class="col-sm-9">
									<input id='channel_unit2' type="text" class="form-control">
								</div>
							</div>
							<div class="form-group onlyBi">
								<label class="col-sm-3 control-label"><fmt:message key="channel_val" bundle="${bundle }"/></label>
								<div class="col-sm-9">
