			...
			<div id="content" class="container-fluid bluebk">
				<div class="channels conf-container">	
					...
					<div class="left chl-info">
						<div class="ai info formstyle">
							<form class="form" onsubmit="return false;">
								<div class="form-group">
									<label class="control-label">端子</label>
									<div class="">
										<input id='' type="text" class="form-control" disabled>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label">通道类别</label>
									<div class="">
										<input id='' type="text" class="form-control" disabled>
									</div>
								</div>
								...
								<div class="form-group onlyAi">
									<label class="control-label">相别</label>
									<div class="">
										<input id='' type="text" class="form-control" disabled>
									</div>
								</div>
								<div class="form-group onlyAi">
									<label class="control-label">额定值</label>
									<div class="">
										<input id='' type="text" class="form-control" disabled>
									</div>
								</div>
								<div class="form-group onlyAi">
									<label class="control-label">最小/大值</label>
									<div class="range">
										<input id='' type="text" class="form-control" disabled>
										~
										<input id='' type="text" class="form-control" disabled>
